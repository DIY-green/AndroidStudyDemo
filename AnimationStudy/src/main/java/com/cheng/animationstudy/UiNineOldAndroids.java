...
public class UiNineOldAndroids extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRootView = (RelativeLayout) getLayoutInflater().inflate(R.layout.ui_nineoldandroids, null);
        setContentView(mRootView);

        Logger.TAG = "UiNineOldAndroids";
        initView();
        initListener();
    }
