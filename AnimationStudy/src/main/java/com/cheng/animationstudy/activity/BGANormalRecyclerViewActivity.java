...
public class BGANormalRecyclerViewActivity extends AppCompatActivity implements BGAOnRVItemClickListener, BGAOnRVItemLongClickListener, BGAOnItemChildClickListener, BGARefreshLayout.BGARefreshLayoutDelegate  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bganormalrecyclerview);
    ...
    private void initView() {
        this.mRefreshLayout = ViewFinder.findViewById(this, R.id.rl_normalrecyclerview);
        this.mBanner = ViewFinder.findViewById(this, R.id.banner_normalrecyclerview);
        this.mDataRV = ViewFinder.findViewById(this, R.id.datarv_normalrecyclerview);
    }
    ...
    private void initBanner() {
        ...
        for (int i = 0; i < 5; i++) {
            views.add(View.inflate(this, R.layout.item_bgabanner_img, null));
            tips.add("我是图片00" + i);
        }
