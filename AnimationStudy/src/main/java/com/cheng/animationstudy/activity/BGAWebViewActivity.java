...
public class BGAWebViewActivity extends AppCompatActivity implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bgawebview);
    ...
    private void initView() {
        ...
        this.mContentWV = ViewFinder.findViewById(this, R.id.wv_content);
    }
