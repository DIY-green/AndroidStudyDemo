...
public class LayoutAnimHideShowActivity extends AppCompatActivity {

    private ViewGroup mContainerVG = null;
    private ViewGroup mParentVG;
    private CheckBox mHideGoneCB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layoutanimhideshow);
        initView();
        initListener();
    }

    private void initView() {
        this.mHideGoneCB = ViewFinder.findViewById(this, R.id.cb_hideGone);
        this.mCustomAnimCB = ViewFinder.findViewById(this, R.id.cb_customanim);
        this.mParentVG = ViewFinder.findViewById(this, R.id.vg_parent);
        this.mAddBtn = ViewFinder.findViewById(this, R.id.btn_addnew);
        this.mContainerVG = new LinearLayout(this);
        this.mContainerVG.setLayoutParams(new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.MATCH_PARENT));
    }

    private void initListener() {
        // Add a slew of buttons to the mContainerVG. We won't add any more buttons
        // at runtime, but
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            newButton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    v.setVisibility(mHideGoneCB.isChecked() ? View.GONE
                            : View.INVISIBLE);
                }
            });
        }
        ...
        this.mAddBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                for (int i = 0; i < mContainerVG.getChildCount(); ++i) {
                    View view = (View) mContainerVG.getChildAt(i);
                    view.setVisibility(View.VISIBLE);
                }
            }
        });

        this.mCustomAnimCB.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
    ...
    private void resetTransition() {
        ...
        mContainerVG.setLayoutTransition(mTransitioner);
    }
