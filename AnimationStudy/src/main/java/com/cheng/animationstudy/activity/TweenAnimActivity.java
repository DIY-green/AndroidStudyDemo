 ...
 */
public class TweenAnimActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void initView() {
        this.mAnimImgIV = ViewFinder.findViewById(this, R.id.iv_animimg);
        this.mCustomAnimTAV = ViewFinder.findViewById(this, R.id.tav_customanim);
        this.mKeepAnimStatusCB = ViewFinder.findViewById(this, R.id.cb_keepanimstatus);
        this.mLoadAnimByXmlCB = ViewFinder.findViewById(this, R.id.cb_loadanimbyxml);
        this.mFlipper = ViewFinder.findViewById(this, R.id.vf_showflipperanim);
        this.mFlipperSpinner = ViewFinder.findViewById(this, R.id.spinner_showflipperanim);
        this.mInterpolatorSpinner = ViewFinder.findViewById(this, R.id.spinner_interpolatoranim);
        this.mInterpolatorTarget = ViewFinder.findViewById(this, R.id.tv_interploatoranim_target);
        this.mInterpolatorTargetParent = (View) mInterpolatorTarget.getParent();

        this.mCustomAnimTAV.setFocusable(true);
        this.mCustomAnimTAV.findFocus();
        ...
        this.mFlipperSpinner.setAdapter(flipperAdapter);
        this.mFlipperSpinner.setOnItemSelectedListener(this);
        ...
        this.mInterpolatorSpinner.setAdapter(interpolatorSadapter);
        this.mInterpolatorSpinner.setOnItemSelectedListener(this);
    }
    ...
    public void showAnimSet03(View v) {
        boolean isKeepAnimStatus = this.mKeepAnimStatusCB.isChecked();
        // 动画集
        Animation anim = AnimationUtils.loadAnimation(TweenAnimActivity.this, R.anim.sda_animationset_anim);
