...
//            debug("头部视图没有完全隐藏  navViewTopOnScreenY = " + navViewTopOnScreenY + "   contentOnScreenTopY = " + contentOnScreenTopY);
    ...
    public boolean isContentViewToTop() {
        ...
        if (BGAScrollingUtil.isScrollViewOrWebViewToTop(mDirectWebView)) {
            return true;
        }

        if (BGAScrollingUtil.isScrollViewOrWebViewToTop(mDirectScrollView)) {
            return true;
        }

        if (BGAScrollingUtil.isAbsListViewToTop(mDirectAbsListView)) {
            return true;
        }

        if (BGAScrollingUtil.isRecyclerViewToTop(mDirectRecyclerView)) {
            return true;
        }
    ...
    private boolean isViewPagerContentViewToTop() {
        ...
        if (BGAScrollingUtil.isScrollViewOrWebViewToTop(mNestedWebView)) {
            return true;
        }

        if (BGAScrollingUtil.isScrollViewOrWebViewToTop(mNestedScrollView)) {
            return true;
        }

        if (BGAScrollingUtil.isAbsListViewToTop(mNestedAbsListView)) {
            return true;
        }

        if (BGAScrollingUtil.isRecyclerViewToTop(mNestedRecyclerView)) {
            return true;
        }
    ...
    public boolean shouldHandleLoadingMore() {
        ...
        if (BGAScrollingUtil.isWebViewToBottom(mDirectWebView)) {
            return true;
        }

        if (BGAScrollingUtil.isScrollViewToBottom(mDirectScrollView)) {
            return true;
        }
        ...
        if (mDirectViewPager != null) {
            ...
            if (BGAScrollingUtil.isWebViewToBottom(mNestedWebView)) {
                return true;
            }

            if (BGAScrollingUtil.isScrollViewToBottom(mNestedScrollView)) {
                return true;
            }
