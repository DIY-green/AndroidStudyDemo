 ...
 */
final class DiyBakedBezierInterpolator implements Interpolator {
    private static final DiyBakedBezierInterpolator INSTANCE = new DiyBakedBezierInterpolator();

    public final static DiyBakedBezierInterpolator getInstance() {
        return INSTANCE;
    }
     ...
     */
    private DiyBakedBezierInterpolator() {
        super();
    }
