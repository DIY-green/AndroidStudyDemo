 ...
 * trigger a refresh).
 */
final class DiySwipeProgressBar {
    ...
    private static final Interpolator INTERPOLATOR = DiyBakedBezierInterpolator.getInstance();
    ...
    public DiySwipeProgressBar(View parent) {
        mParent = parent;
        mColor1 = COLOR1;
        mColor2 = COLOR2;
        mColor3 = COLOR3;
