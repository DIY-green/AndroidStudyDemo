...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    public static final int LARGE = SwipyMaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = SwipyMaterialProgressDrawable.DEFAULT;
    ...
    private SwipyCircleImageView mCircleView;
    ...
    private SwipyMaterialProgressDrawable mProgress;
    ...
    public void setSize(int size) {
        if (size != SwipyMaterialProgressDrawable.LARGE && size != SwipyMaterialProgressDrawable.DEFAULT) {
            return;
        }
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (size == SwipyMaterialProgressDrawable.LARGE) {
    ...
    private void createProgressView() {
        mCircleView = new SwipyCircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
        mProgress = new SwipyMaterialProgressDrawable(getContext(), this);
