 ...
 *
 */
public class SunRosePullToRefreshView extends ViewGroup {
    ...
    public SunRosePullToRefreshView(Context context) {
        this(context, null);
    }

    public SunRosePullToRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SunRoseRefreshView);
        final int type = typedArray.getInteger(R.styleable.SunRoseRefreshView_type, STYLE_SUN);
        typedArray.recycle();

        mDecelerateInterpolator = new DecelerateInterpolator(DECELERATE_INTERPOLATION_FACTOR);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        mTotalDragDistance = UiUtil.dipToPx(context, DRAG_MAX_DISTANCE);
    ...
    public void setRefreshStyle(int type) {
        ...
        switch (type) {
            case STYLE_SUN:
                mBaseRefreshView = new SunRoseRefreshView(getContext(), this);
                break;
            case STYLE_JET:
                // TODO
            default:
