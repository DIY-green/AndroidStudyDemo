...
public class UiSunRosePullToRefreshAnim extends AppCompatActivity implements SunRosePullToRefreshView.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ui_sunrosepulltorefreshanim);
    ...
    private void initView() {
        this.mSunRosePullToRefreshView = ViewFinder.findViewById(this, R.id.sdi_sunrose_ptrv);
        this.mSunRoseLV = ViewFinder.findViewById(this, R.id.sdi_sunrose_lv);
    }
    ...
    private void initData() {
        ...
        this.mSunRoseLV.setAdapter(new SampleAdapter(this, R.layout.ui_sunroselist_item, sampleList));
    }
    ...
    class SampleAdapter extends ArrayAdapter<Map<String, Integer>> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.ui_sunroselist_item, parent, false);
