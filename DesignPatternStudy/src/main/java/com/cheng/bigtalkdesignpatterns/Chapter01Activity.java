...
import com.cheng.bigtalkdesignpatterns.builder.BTDPBuilderActivity;

import java.util.Arrays;

public class Chapter01Activity extends AppCompatActivity {

    private static final String TAG = "Chapter01Activity";
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter01Activity.this, BTDPBuilderActivity.class);
