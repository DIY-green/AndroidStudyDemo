...
import com.cheng.bigtalkdesignpatterns.decorator.BTDPDecotatorActivity;

import java.util.Arrays;

public class Chapter06Activity extends AppCompatActivity {

    private static final String TAG = "Chapter06Activity";
    ...
    private void initData() {
        String[] suggests = getResources()
                .getStringArray(R.array.btdpchapter6);
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter06Activity.this, BTDPDecotatorActivity.class);
