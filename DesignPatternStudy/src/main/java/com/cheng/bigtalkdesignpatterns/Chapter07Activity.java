...
import com.cheng.bigtalkdesignpatterns.proxy.BTDPProxyActivity;

import java.util.Arrays;

public class Chapter07Activity extends AppCompatActivity {

    private static final String TAG = "Chapter07Activity";
    ...
    private void initData() {
        String[] suggests = getResources()
                .getStringArray(R.array.btdpchapter7);
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter07Activity.this, BTDPProxyActivity.class);
