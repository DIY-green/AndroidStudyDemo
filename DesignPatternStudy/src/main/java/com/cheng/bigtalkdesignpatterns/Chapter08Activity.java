...
import com.cheng.bigtalkdesignpatterns.factorymethod.BTDPFactoryMethodActivity;

import java.util.Arrays;

public class Chapter08Activity extends AppCompatActivity {

    private static final String TAG = "Chapter08Activity";
    ...
    private void initData() {
        String[] suggests = getResources()
                .getStringArray(R.array.btdpchapter8);
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter08Activity.this, BTDPFactoryMethodActivity.class);
