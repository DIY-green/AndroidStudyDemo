...
import com.cheng.bigtalkdesignpatterns.templatemethod.BTDPTemplateMethodActivity;

import java.util.Arrays;

public class Chapter10Activity extends AppCompatActivity {

    private static final String TAG = "Chapter10Activity";
    ...
    private void initData() {
        String[] suggests = getResources()
                .getStringArray(R.array.btdpchapter10);
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter10Activity.this, BTDPTemplateMethodActivity.class);
