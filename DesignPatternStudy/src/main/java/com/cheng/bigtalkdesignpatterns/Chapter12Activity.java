...
import com.cheng.bigtalkdesignpatterns.facade.BTDPFacadeActivity;

import java.util.Arrays;

public class Chapter12Activity extends AppCompatActivity {

    private static final String TAG = "Chapter12Activity";
    ...
    private void initData() {
        String[] suggests = getResources()
                .getStringArray(R.array.btdpchapter12);
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter12Activity.this, BTDPFacadeActivity.class);
