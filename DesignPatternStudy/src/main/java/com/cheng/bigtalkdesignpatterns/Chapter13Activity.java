...
import com.cheng.bigtalkdesignpatterns.simplefactory.BTDPSimpleFactoryActivity;

import java.util.Arrays;

public class Chapter13Activity extends AppCompatActivity {

    private static final String TAG = "Chapter13Activity";
    ...
    private void initData() {
        String[] suggests = getResources()
                .getStringArray(R.array.btdpchapter13);
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter13Activity.this, BTDPSimpleFactoryActivity.class);
