...
import com.cheng.bigtalkdesignpatterns.observer.BTDPObserverActivity;

import java.util.Arrays;

public class Chapter14Activity extends AppCompatActivity {

    private static final String TAG = "Chapter14Activity";
    ...
    private void initData() {
        String[] suggests = getResources()
                .getStringArray(R.array.btdpchapter14);
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter14Activity.this, BTDPObserverActivity.class);
