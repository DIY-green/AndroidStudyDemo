...
import com.cheng.bigtalkdesignpatterns.abstractfactory.BTDPAbstractFactoryActivity;
...
public class Chapter15Activity extends AppCompatActivity {
    ...
    private static final String TAG = "Chapter15Activity";
    ...
    private void initData() {
        String[] suggests = getResources()
                .getStringArray(R.array.btdpchapter15);
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter15Activity.this, BTDPAbstractFactoryActivity.class);
