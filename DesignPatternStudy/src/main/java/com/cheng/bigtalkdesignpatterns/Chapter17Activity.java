...
import com.cheng.bigtalkdesignpatterns.adapter.UiBTDPAdapter;
import com.cheng.bigtalkdesignpatterns.listadapter.BigTalkDesignPatternsListAdapter;

import java.util.Arrays;

public class Chapter17Activity extends AppCompatActivity {

    private static final String TAG = "Chapter17Activity";
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter17Activity.this, UiBTDPAdapter.class);
