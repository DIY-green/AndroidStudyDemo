...
import com.cheng.bigtalkdesignpatterns.memento.BTDPMementoActivity;

import java.util.Arrays;

public class Chapter18Activity extends AppCompatActivity {

    private static final String TAG = "Chapter18Activity";
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter18Activity.this, BTDPMementoActivity.class);
