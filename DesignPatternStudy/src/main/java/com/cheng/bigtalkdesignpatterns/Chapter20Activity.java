...
import com.cheng.bigtalkdesignpatterns.iterator.BTDPIteratorActivity;
import com.cheng.bigtalkdesignpatterns.listadapter.BigTalkDesignPatternsListAdapter;

import java.util.Arrays;

public class Chapter20Activity extends AppCompatActivity {

    private static final String TAG = "Chapter20Activity";
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter20Activity.this, BTDPIteratorActivity.class);
