...
import com.cheng.bigtalkdesignpatterns.singleton.BTDPSingletonActivity;

import java.util.Arrays;

public class Chapter21Activity extends AppCompatActivity {

    private static final String TAG = "Chapter21Activity";
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter21Activity.this, BTDPSingletonActivity.class);
