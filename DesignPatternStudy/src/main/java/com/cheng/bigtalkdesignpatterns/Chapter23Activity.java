...
import com.cheng.bigtalkdesignpatterns.command.BTDPCommandActivity;
import com.cheng.bigtalkdesignpatterns.listadapter.BigTalkDesignPatternsListAdapter;

import java.util.Arrays;

public class Chapter23Activity extends AppCompatActivity {

    private static final String TAG = "Chapter23Activity";
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter23Activity.this, BTDPCommandActivity.class);
