...
import com.cheng.bigtalkdesignpatterns.chainofresponsibility.BTDPChainofResponsibilityActivity;
import com.cheng.bigtalkdesignpatterns.listadapter.BigTalkDesignPatternsListAdapter;

import java.util.Arrays;

public class Chapter24Activity extends AppCompatActivity {

    private static final String TAG = "Chapter24Activity";
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter24Activity.this, BTDPChainofResponsibilityActivity.class);
