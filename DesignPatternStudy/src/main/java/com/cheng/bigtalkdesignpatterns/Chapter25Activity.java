...
import com.cheng.bigtalkdesignpatterns.mediator.BTDPMediatorActivity;

import java.util.Arrays;

public class Chapter25Activity extends AppCompatActivity {

    private static final String TAG = "Chapter25Activity";
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter25Activity.this, BTDPMediatorActivity.class);
