...
import com.cheng.bigtalkdesignpatterns.interpreter.BTDPInterpreterActivity;
import com.cheng.bigtalkdesignpatterns.listadapter.BigTalkDesignPatternsListAdapter;

import java.util.Arrays;

public class Chapter27Activity extends AppCompatActivity {

    private static final String TAG = "Chapter27Activity";
    ...
    private void initListener() {
        this.mListHeaderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chapter27Activity.this, BTDPInterpreterActivity.class);
