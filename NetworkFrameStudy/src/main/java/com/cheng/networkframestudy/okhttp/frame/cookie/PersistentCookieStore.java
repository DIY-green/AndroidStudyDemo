...
public class PersistentCookieStore implements CookieStore {
    ...
    private final HashMap<String, ConcurrentHashMap<String, HttpCookie>> mCookieMap;
    ...
    public List<HttpCookie> get(URI uri) {
        ...
        if (mCookieMap.containsKey(uri.getHost()))
            ret.addAll(mCookieMap.get(uri.getHost()).values());
        return ret;
    }
    ...
    public List<HttpCookie> getCookies() {
        ...
        for (String key : mCookieMap.keySet())
            ret.addAll(mCookieMap.get(key).values());
        return ret;
    }
